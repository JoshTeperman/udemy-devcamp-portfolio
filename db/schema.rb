...
# system, you should be using db:schema:load, not running all the migrationsPor
# from scratch. The latter is a flawed and unsustainable approach (the more migrations
# you'll amass, the slower it'll run and the greater likelihood for issues).
#
# It's strongly recommended that you check this file into your version control system.

ActiveRecord::Schema.define(version: 20191204104558) do
  ...
  create_table "portfolios", force: :cascade do |t|
    ...
    t.string   "subtitle"
    t.text     "body"
    t.text     "main_image",  default: "http://placehold.it/600x400"
    t.text     "thumb_image", default: "http://placehold.it/350x200"
    t.datetime "created_at",                                          null: false
    t.datetime "updated_at",                                          null: false
  end
